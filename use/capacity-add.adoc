...
= Expand storage capacity with Lifecycle planning
:hardbreaks:
:icons: font
:imagesdir: ../media/use/
...
One of the recommendations might be to expand storage by adding shelves to your existing serial number. 
...
. Select *Storage Expansion* (previously Add Capacity).
+
